...
import { LineChartIcon, BarChartIcon, TrendingUpIcon, GaugeIcon } from "./components/Icons";
  ...
  return (
    <div className="mx-auto w-full">
        <header className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-white">Revenue & Valuation Simulation</h1>
          <p className="text-base text-zinc-400 mt-1">Explore the impact of different pricing strategies and user growth on ARR and company valuation.</p>
        </header>
