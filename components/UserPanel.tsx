...
const UserPanel = forwardRef<HTMLDivElement, UserPanelProps>(
    ({ onGoToFullscreen, isKpiSentimentColoringEnabled, setIsKpiSentimentColoringEnabled, aiChatInterfaceStyle, setAiChatInterfaceStyle, position }, ref) => {
    ...
    return (
        <HeaderPanel ref={ref} position={position}>
            <div className="w-[26rem] max-w-md">
